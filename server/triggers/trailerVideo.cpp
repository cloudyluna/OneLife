...
static void customInit()
{
    ...
    PlayerMapping narrator = {"test@test.com", 433, 39, {-2, 0}, 0, clothing};
...
static void customTrigger(int inTriggerNumber)
{
    ...
    if (inTriggerNumber == t++)
    {
        ...
        eve = newDummyPlayer("dummy4@test.com", 19, 20, startPos, 0, clothing);

        startPos.x = 21;
        startPos.y = 2;
        clothing = getEmptyClothingSet();
        lostBaby = newDummyPlayer("lostBaby@test.com", 347, 1, startPos, 0, clothing);
        ...
        startPos.x = 24;
        startPos.y = 4;
        momA = newDummyPlayer("momA@test.com", 350, 27, startPos, 0, clothing);
        startPos.x = 25;
        clothing = getEmptyClothingSet();
        babyA = newDummyPlayer("babyA@test.com", 351, 1, startPos, 0, clothing);

        clothing.bottom = getObject(200);

        startPos.x = 26;
        startPos.y = 5;
        dadA = newDummyPlayer("dadA@test.com", 355, 27, startPos, 0, clothing);

        startPos.x = 27;
        startPos.y = 5;
        kidA1 = newDummyPlayer("kidA1@test.com", 353, 3, startPos, 0, clothing);
        startPos.x = 30;
        startPos.y = 9;
        kidA2 = newDummyPlayer("kidA2@test.com", 350, 5, startPos, 40, clothing);
        ...
        startPos.x = 27;
        startPos.y = 6;
        grandpaA = newDummyPlayer("grandpaA@test.com", 347, 55, startPos, 0, clothing);
        ...
        startPos.x = 40;
        startPos.y = 1;
        manB1 = newDummyPlayer("manB1@test.com", 347, 28, startPos, 292, clothing);

        startPos.x = 47;
        startPos.y = 3;
        manB2 = newDummyPlayer("manB2@test.com", 354, 57, startPos, 0, clothing);

        startPos.x = 42;
        startPos.y = 2;
        kidB1 = newDummyPlayer("kidB1@test.com", 352, 6, startPos, 135, clothing);

        clothing.tunic = getObject(201);

        startPos.x = 43;
        startPos.y = -1;
        womanB1 = newDummyPlayer("womanB1@test.com", 353, 29, startPos, 139, clothing);

        startPos.x = 45;
        startPos.y = 2;
        womanB2 = newDummyPlayer("womanB2@test.com", 351, 49, startPos, 71, clothing);
        ...
        startPos.x = 59;
        startPos.y = -5;
        kidC1 = newDummyPlayer("kidC1@test.com", 19, 5, startPos, 0, clothing);

        startPos.x = 59;
        startPos.y = -4;
        kidC2 = newDummyPlayer("kidC2@test.com", 354, 8, startPos, 277, clothing);

        clothing.hat = getObject(199);
        startPos.x = 56;
        startPos.y = -5;
        manC1 = newDummyPlayer("manC1@test.com", 355, 56, startPos, 248, clothing);

        clothing.hat = getObject(199);
        clothing.tunic = getObject(585);
        startPos.x = 75;
        startPos.y = -7;
        manD1 = newDummyPlayer("manD1@test.com", 352, 20, startPos, 583, clothing);

        clothing.hat = NULL;
        clothing.tunic = getObject(201);
        startPos.x = 78;
        startPos.y = -7;
        manD2 = newDummyPlayer("manD2@test.com", 347, 32, startPos, 560, clothing);

        startPos.x = 69;
        startPos.y = -8;
        womanD1 = newDummyPlayer("womanD1@test.com", 350, 12.5, startPos, 441, clothing);

        startPos.x = 81;
        startPos.y = -7;
        womanD2 = newDummyPlayer("womanD2@test.com", 351, 20, startPos, 67, clothing);
        ...
        startPos.x = 91;
        startPos.y = -8;
        manE1 = newDummyPlayer("manE1@test.com", 355, 37.5, startPos, 334, clothing);

        startPos.x = 93;
        startPos.y = -8;
        womanE1 = newDummyPlayer("womanE1@test.com", 19, 23, startPos, 334, clothing);
        ...
        clothing = getEmptyClothingSet();
        clothing.tunic = getObject(585);
        carDriver = newDummyPlayer("dummy2@test.com", 19, 20, startPos, 630, clothing);
        ...
        startPos.x = 116;
        startPos.y = -11;
        transportDriver = newDummyPlayer("dummy3@test.com", 19, 20, startPos, 632, clothing);
    }
    ...
    else if (inTriggerNumber == t++)
    {
        ...
        firstBaby = newDummyPlayer("dummy5@test.com", 350, 0, startPos, 0, clothing);
    }
    else if (inTriggerNumber == t++)
    {
        // grab baby
    ...
    else if (inTriggerNumber == t++)
    {
        ...
        robotDummy = newDummyPlayer("robotDummy@test.com", 650, 0, startPos, 0, clothing);
    ...
    else if (inTriggerNumber == t++)
    {
        ...
        wolfDummy = newDummyPlayer("dummy3@test.com", 418, 0, startPos, 0, clothing);
    }
    else if (inTriggerNumber == t++)
    {
    ...
    else if (inTriggerNumber == t++)
    {
        ...
        firstBaby = newDummyPlayer("dummy2@test.com", 19, 0, startPos, 0, clothing);
