...
static void customInit()
{
    ...
    PlayerMapping narrator = {"test@test.com", 433, 20, {0, 0}, 0, clothing};
...
static void customTrigger(int inTriggerNumber)
{
    ...
    if (inTriggerNumber == t++)
    {
        ...
        eve = newDummyPlayer("dummy1@test.com", 19, 14, startPos, 0, clothing);
    }
    ...
    else if (inTriggerNumber == t++)
    {
        ...
        bob = newDummyPlayer("dummy3@test.com", 352, 50, startPos, 0, clothing);

        GridPos startPosB = {25, -19};

        clothing.tunic = getObject(201);

        alice = newDummyPlayer("dummy4@test.com", 350, 20, startPosB, 67, clothing);

        GridPos startPosC = {28, -18};

        clothing.tunic = NULL;

        bobby = newDummyPlayer("dummy5@test.com", 347, 6, startPosC, 0, clothing);
    }
    else if (inTriggerNumber == t++)
    {
        // grab bow
