...
char *mapLanguagePhrase(char *inPhrase, int inEveIDA, int inEveIDB, int inPlayerIDA, int inPlayerIDB,
                        // ages in years
                        double inAgeA, double inAgeB, int inParentIDA, int inParentIDB);
