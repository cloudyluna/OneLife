...
void addCountAndValue(SimpleVector<FoodRec> *inRecList, int inID, int inCount, int inValue)
{
    ...
    if (f != NULL)
    {
        ...
        while (scannedLine)
        {
            ...
            int numScanned = fscanf(f,
                                    "id=%d count=%d value=%d av_age=%lf "
                                    "av_mapX=%d av_mapY=%d\n",
...
void printTable(const char *inName, File *inObjectDir, FILE *inFile, SimpleVector<FoodRec> *inRecList)
{
...
int main(int inNumArgs, char **inArgs)
{
    ...
    if (mainDir.exists() && mainDir.isDirectory() && objDir.exists() && objDir.isDirectory())
    {
        ...
        if (outFile != NULL)
        {
            ...
            printTable("Past week", &objDir, outFile, &weekRecords);

            printTable("Past month", &objDir, outFile, &monthRecords);
