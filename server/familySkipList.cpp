...
static FamilySkipListRecord *findRecord(char *inBabyEmail, char inMakeNew = false)
{
    ...
    FamilySkipListRecord newR = {stringDuplicate(inBabyEmail), new SimpleVector<int>(), curTime};
