        ...
        for (int i = 0; i <= maxSeenObjectID; i++)
        {
            ...
            if (eatFoodCounts[i] > 0)
            {
                ...
                fprintf(logFile,
                        ...
                        "av_mapX=%d av_mapY=%d\n",
                        i, eatFoodCounts[i], eatFoodValueCounts[i], eaterAgeSums[i] / eatFoodCounts[i],
...
void logEating(int inFoodID, int inFoodValue, double inEaterAge, int inMapX, int inMapY)
{
