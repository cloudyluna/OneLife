...
void playSound(int inID, double inVolumeTweak = 1.0, double inStereoPosition = 0.5, double inReverbMix = 0.0);

void playSound(SoundUsage inUsage, double inStereoPosition = 0.5, double inReverbMix = 0.0);
