...
static void writeAiffFile(File *inFile, int inSampleRate, int16_t *inSamples, int inNumSamples)
{
    int headerLength;
    unsigned char *header = getAIFFHeader(1, 16, inSampleRate, inNumSamples, &headerLength);
...
int main(int inNumArgs, char **inArgs)
{
    ...
    convolve(aFloats, numA, bFloats, numB, wetSampleFloats);
