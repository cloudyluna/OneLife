...
class LivingLifePage : public GamePage, public ActionListener
{
  ...
  public:
    ...
    void adjustAllFrameCounts(double inOldFrameRateFactor, double inNewFrameRateFactor);
  ...
  protected: // minitech
    ...
    void drawHungerMaxFillLine(doublePair inAteWordsPos, int inMaxFill, SpriteHandle *inBarSprites,
  ...
  protected: // minitech
    ...
    void drawChalkBackgroundString(doublePair inPos, const char *inString, double inFade, double inMaxWidth,
                                   LiveObject *inSpeaker = NULL, int inForceMinChalkBlots = -1,
                                   FloatColor *inForceBlotColor = NULL, FloatColor *inForceTextColor = NULL,
                                   bool tinyStyle = false, bool allowOffscreen = false);
    ...
    ObjectAnimPack drawLiveObject(LiveObject *inObj, SimpleVector<LiveObject *> *inSpeakers,
                                  SimpleVector<doublePair> *inSpeakersPos);

    void drawMapCell(int inMapI, int inScreenX, int inScreenY, char inHighlightOnly = false,
                     // blocks frame update for cell and animation sounds
                     char inNoTimeEffects = false);

    void checkForPointerHit(PointerHitRecord *inRecord, float inX, float inY);
    ...
    void handleAnimSound(int inObjectID, double inAge, AnimType inType, int inOldFrameCount, int inNewFrameCount,
