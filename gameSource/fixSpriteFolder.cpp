// compile with:
// g++ -o fixSpriteFolder fixSpriteFolder.cpp -I../.. ../../minorGems/util/stringUtils.o
// ../../minorGems/io/file/linux/PathLinux.o
                ...
                for (int t = 0; t < numTGAFiles; t++)
                {
                    ...
                    if (!tgaFiles[t]->isDirectory())
                    {
                        ...
                        if (strstr(tgaFileName, ".tga") != NULL)
                        {
                            ...
                            unsigned char *tgaData = tgaFiles[t]->readFileContents(&tgaDataLength);
                            ...
                            File *newTGAFile = spritesDir.getChildFile(newTGAName);

                            File *newTXTFile = spritesDir.getChildFile(newTXTName);
                            ...
                            char *txtData = autoSprintf("%s %d", tag, mult);
