...
class TextField : public PageComponent, public ActionListenerList
{
  ...
  public:
    ...
    TextField(Font *inDisplayFont, double inX, double inY, int inCharsWide, char inForceCaps = false,
              const char *inLabelText = NULL, const char *inAllowedChars = NULL, const char *inForbiddenChars = NULL,
    ...
    void setFloat(float inF, int inDigitsAfterDecimal = -1, char inTrimZeros = false);
    ...
    static void setDeleteRepeatDelays(int inFirstDelaySteps, int inNextDelaySteps);
