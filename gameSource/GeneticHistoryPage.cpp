...
GeneticHistoryPage::GeneticHistoryPage()
    : mBackButton(mainFont, -522, 300, translate("backButton")),
      ...
      mLeaderboardButton(mainFont, 322, 300, translate("leaderboard")), mRefreshTime(0), mSkip(0)
{
...
void GeneticHistoryPage::draw(doublePair inViewCenter, double inViewSize)
{

    if (!mRefreshButton.isVisible() && game_getCurrentTime() - mRefreshTime > 10)
    {
