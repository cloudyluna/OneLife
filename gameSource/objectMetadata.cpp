...
TransRecord *getMetaTrans(int inActor, int inTarget, char inLastUseActor, char inLastUseTarget)
{
    ...
    TransRecord *r = getTrans(inActor, inTarget, inLastUseActor, inLastUseTarget);
    ...
    *rStatic = *r;
    ...
    if (passThroughMeta != 0)
    {
        ...
        else if (rStatic->newTarget > 0 && getObject(rStatic->newTarget)->mayHaveMetadata)
        {
