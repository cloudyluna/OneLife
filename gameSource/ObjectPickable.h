...
class ObjectPickable : public Pickable
{
  ...
  public:
                          ...
                          int *outNumRemaining)
    {
        ...
        {
            int *stackResults = getStackRange(inNumToSkip, inNumToGet, outNumResults, outNumRemaining);
        ...
        {
            return (void **)searchObjects(inSearch, inNumToSkip, inNumToGet, outNumResults, outNumRemaining);
        }
    }
    ...
    virtual void draw(void *inObject, doublePair inPos)
    {
        ...
        drawObject(r, 2, inPos, 0, false, false, 20, 0, false, false, getEmptyClothingSet());
    ...
    {
        return deletePossible && !isObjectUsed(inID) && !isObjectUsedInCategories(inID);
    }
