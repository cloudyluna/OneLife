...
TestPage::TestPage()
    : mSpriteA(loadSpriteBase("sprites/77.tga", false)), mSpriteABlank(loadSpriteBase("77_78_blank.tga", false)),
      mSpriteB(loadSpriteBase("sprites/78.tga", false)), mSpriteC(loadSpriteBase("77_78.tga", false)),
      mSpriteD(loadSpriteBase("77_78_crop.tga", false))
{
    ...
    mSpriteB_bw = fillSpriteAlphaOnly(alphaBytes, sprite78->getWidth(), sprite78->getHeight());
    delete sprite78;
    delete[] alphaBytes;
}
...
void TestPage::draw(doublePair inViewCenter, double inViewSize)
{
