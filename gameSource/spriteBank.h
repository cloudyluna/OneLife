...
int addSprite(const char *inTag, SpriteHandle inSprite, Image *inSourceImage, char inMultiplicativeBlending,
              int inCenterAnchorXOffset = 0, int inCenterAnchorYOffset = 0);
...
int bakeSprite(const char *inTag, int inNumSprites, int *inSpriteIDs,
               // offset of each sprite center relative to center point
               doublePair *inSpritePos, double *inSpriteRot, char *inSpriteHFlips, FloatRGB *inSpriteColors);
