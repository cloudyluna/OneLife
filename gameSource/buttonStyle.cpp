...
void setOHOLGreyButtonStyle(Button *inButton)
{
    ...
    inButton->setInactiveColor(0.5, 0.5, 0.5,
                               1); // Originally a black overlay (0, 0, 0, 0.5) is drawn on the button to gray it out
    ...
    inButton->setInactiveFillColor(
        0.125, 0.125, 0.125, 1); // Originally a black overlay (0, 0, 0, 0.5) is drawn on the button to gray it out
    ...
    inButton->setInactiveBorderColor(
        0.25, 0.25, 0.25, 1); // Originally a black overlay (0, 0, 0, 0.5) is drawn on the button to gray it out
...
void setOHOLBlackButtonStyle(Button *inButton)
{
    ...
    inButton->setInactiveFillColor(
        0, 0, 0, 1); // Originally a black overlay (0, 0, 0, 0.5) is drawn on the button to gray it out
...
void set2HOLOldButtonStyle(Button *inButton)
{
    ...
    inButton->setInactiveColor(0, 0, 0,
                               1); // Originally a black overlay (0, 0, 0, 0.5) is drawn on the button to gray it out
    ...
    inButton->setDragOverFillColor(0, 0, 0, 1);
    inButton->setInactiveFillColor(
        0.5, 0.375, 0.1, 1); // Originally a black overlay (0, 0, 0, 0.5) is drawn on the button to gray it out
