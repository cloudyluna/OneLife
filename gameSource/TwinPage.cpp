...
TwinPage::TwinPage()
    : mCodeField(mainFont, 0, 128, 13, false, translate("twinCode"), NULL, NULL),
      mGenerateButton(mainFont, 0, 49, translate("generate")), mCopyButton(mainFont, 400, 170, translate("copy")),
      mPasteButton(mainFont, 400, 86, translate("paste")), mLoginButton(mainFont, 400, -280, translate("loginButton")),
      mCancelButton(mainFont, -400, -280, translate("cancel"))
{
    ...
    mPlayerCountRadioButtonSet = new RadioButtonSet(mainFont, 0, -100, 3, choiceList, false, 4);
...
void TwinPage::draw(doublePair inViewCenter, double inViewSize)
{
