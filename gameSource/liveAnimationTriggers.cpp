    ...
    while (readTrigger)
    {
        ...
        if (numRead == 1)
        {
            ...
            if (strcmp(buffer, "anim") == 0)
            {
                ...
                numRead = fscanf(f, "%d %d", &(t.extraAnimIndex), &(t.stepDuration));
            ...
            else if (strcmp(buffer, "server") == 0)
            {
                ...
                if (numRead == 1)
                {
                    ...
                    else
                    {
                        ...
                        numRead = sscanf(buffer, "%d", &(t.serverTriggerNumber));
    ...
    if (inASCII == triggerKey)
    {
        ...
        if (triggers.size() > 0)
        {
            ...
            if (nextTrigger.isServerTrigger)
            {
                ...
                char *message = autoSprintf("TRIGGER %d#", nextTrigger.serverTriggerNumber);
            ...
            {
                char *message = autoSprintf("SAY 0 0 %s#", nextTrigger.sayMessage);
        ...
        else
        {
            ...
            char *message = autoSprintf("TRIGGER %d#", lastPlayedServerTrigger);
