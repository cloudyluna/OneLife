...
class RadioButtonSet : public PageComponent, public ActionListenerList, public ActionListener
{

  public:
    RadioButtonSet(Font *inDisplayFont, double inX, double inY, int inNumItems, const char **inItemNames,
                   // true to put labels on right side
                   char inRightLabels = false, double inDrawScale = 1.0, char inDrawNamesWithShadow = false);
