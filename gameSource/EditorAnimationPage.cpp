...
EditorAnimationPage::EditorAnimationPage()
    : mCenterMarkSprite(loadSprite("centerMark.tga")), mGroundSprite(loadWhiteSprite("testGround.tga")),
      mObjectEditorButton(mainFont, 0, 260, "Objects"), mSceneEditorButton(mainFont, -150, 260, "Scene"),
      mSaveButton(smallFont, 0, 200, "Save"), mDeleteButton(smallFont, 140, 200, "Delete"),
      mObjectPicker(&objectPickable, +410, 90), mSoundWidget(smallFont, -120, -200),
      mSoundRepeatPerSecSlider(smallFont, -120, -264, 2, 100, 20, 0, 6, "Loop Hz"),
      mSoundRepeatPhaseSlider(smallFont, -120, -296, 2, 100, 20, 0, 1, "Loop Phase"),
      mSoundAgeInField(smallFont, -180, -328, 6, false, "In", "0123456789.", NULL),
      mSoundAgeOutField(smallFont, -50, -328, 6, false, "Out", "0123456789.", NULL),
      mSoundAgePunchInButton(smallFont, -130, -328, "S"), mSoundAgePunchOutButton(smallFont, 0, -328, "S"),
      mSoundFootstepButton("footstepOffButton.tga", "footstepOnButton.tga", 35, -328),
      mPersonAgeSlider(smallFont, 100, -212, 2, 100, 20, 0, 100, "Age"), mPlayAgeButton(smallFont, 264, -212, "P"),
      mPlayingAge(false), mTestSpeedSlider(smallFont, 100, -170, 2, 100, 20, 0, 1, "Test Speed"),

      mPrevExtraButton(smallFont, 250, -85, "<"), mNextExtraButton(smallFont, 310, -85, ">"),
      mDelExtraButton(smallFont, 280, -85, "x"),

      mReverseRotationCheckbox(0, 0, 2), mRandomStartPhaseCheckbox(-80, 200, 2), mForceZeroStartCheckbox(-80, 180, 2),
      mCurrentObjectID(-1), mCurrentSlotDemoID(-1), mFlipDraw(false), mHideUI(false), mWiggleAnim(NULL),
      mWiggleFade(0.0), mWiggleSpriteOrSlot(-1), mRotCenterFade(0.0), mCurrentType(ground), mLastType(ground),
      mLastTypeFade(0), mFrameCount(0), mLastTypeFrameCount(0), mFrozenRotFrameCount(0),
      mFrozenRotFrameCountUsed(false), mCurrentSound(0), mCurrentSpriteOrSlot(0), mSettingRotCenter(false),
      mPickSlotDemoButton(smallFont, 280, 90, "Fill Slots"), mPickingSlotDemo(false),
      mClearSlotDemoButton(smallFont, 280, -100, "Clear Slots"), mPickClothingButton(smallFont, 280, 100, "+ Clothes"),
      mPickingClothing(false), mClearClothingButton(smallFont, 280, 140, "X Clothes"),
      mPickHeldButton(smallFont, 280, -120, "+ Held"), mPickingHeld(false), mHeldID(-1),
      mClearHeldButton(smallFont, 280, -160, "X Held"), mPickSceneryButton(smallFont, 280, 180, "+ Scenery"),
      mPickingScenery(false), mSceneryID(-1), mClearSceneryButton(smallFont, 280, 220, "X Scenery"),
      mCopyButton(smallFont, -390, 230, "Copy"), mCopyChainButton(smallFont, -390, 270, "Copy Child Tree"),
      mCopyChainRandButton(smallFont, -390, 310, "Copy Child Tree Rand Phase"),
      mCopyWalkButton(smallFont, -260, 270, "Copy Walk"), mCopyAllButton(smallFont, -470, 230, "Copy All"),
      mCopyUpButton(smallFont, -500, 270, "Copy Up"), mPasteButton(smallFont, -330, 230, "Paste"),
      mClearButton(smallFont, -270, 230, "Clear"), mNextSpriteOrSlotButton(smallFont, 280, -270, "Next Layer"),
      mPrevSpriteOrSlotButton(smallFont, 100, -270, "Prev Layer"), mChildButton(smallFont, 380, -330, "Child"),
      mParentButton(smallFont, 380, -270, "Parent"), mNextSoundButton(smallFont, -30, -160, ">"),
      mPrevSoundButton(smallFont, -210, -160, "<"), mCopySoundAnimButton(smallFont, -85, -160, "Copy"),
      mCopyAllSoundAnimButton(smallFont, -85, -160, "Copy All"), mPasteSoundAnimButton(smallFont, -155, -160, "Paste"),
      mFullSoundCopyButton(smallFont, -300, -328, "Full Sound Copy"),
      mFullSoundPasteButton(smallFont, 130, -328, "Full Sound Paste"),
      mSpeedMultField(smallFont, -500, -328, 4, false, "Speed x", "0123456789."),
      mSpeedMultApplyButton(smallFont, -446, -328, "Apply")
{
    ...
    mSliders[0] = new ValueSlider(smallFont, x, boxY -= space, 2, 100, 20, 0, 8, "X Osc");

    mXOffsetSlider = new ValueSlider(smallFont, x - 182, mSliders[0]->getPosition().y, 2, 50, 20, -128, 128, "Off");

    mSliders[1] = new ValueSlider(smallFont, x, boxY -= space, 2, 100, 20, 0, 256, "X Amp");
    mSliders[2] = new ValueSlider(smallFont, x, boxY -= space, 2, 100, 20, 0, 1, "X Phase");

    mSliders[3] = new ValueSlider(smallFont, x, boxY -= space, 2, 100, 20, 0, 8, "Y Osc");

    mYOffsetSlider = new ValueSlider(smallFont, x - 182, mSliders[3]->getPosition().y, 2, 50, 20, -128, 128, "Off");

    mSliders[4] = new ValueSlider(smallFont, x, boxY -= space, 2, 100, 20, 0, 256, "Y Amp");
    mSliders[5] = new ValueSlider(smallFont, x, boxY -= space, 2, 100, 20, 0, 1, "Y Phase");

    mSliders[6] = new ValueSlider(smallFont, x, boxY -= space, 2, 100, 20, 0, 12, "Rot");
    ...
    mSliders[7] = new ValueSlider(smallFont, x, boxY -= space, 2, 100, 20, 0, 1, "Rot Phase");

    mSliders[8] = new ValueSlider(smallFont, x, boxY -= space, 2, 100, 20, 0, 8, "Rock Osc");
    mSliders[9] = new ValueSlider(smallFont, x, boxY -= space, 2, 100, 20, 0, 1, "Rock Amp");
    mSliders[10] = new ValueSlider(smallFont, x, boxY -= space, 2, 100, 20, 0, 1, "Rock Phase");

    mSliders[11] = new ValueSlider(smallFont, x, boxY -= space, 2, 100, 20, 0, 8, "Fade Osc");
    mSliders[12] = new ValueSlider(smallFont, x, boxY -= space, 2, 100, 20, 0, 1, "Fade Hard");
    mSliders[13] = new ValueSlider(smallFont, x, boxY -= space, 2, 100, 20, 0, 1, "Fade Min");
    mSliders[14] = new ValueSlider(smallFont, x, boxY -= space, 2, 100, 20, 0, 1, "Fade Max");
    mSliders[15] = new ValueSlider(smallFont, x, boxY -= space, 2, 100, 20, 0, 1, "Fade Phase");

    mSliders[16] = new ValueSlider(smallFont, x, boxY -= space, 2, 100, 20, 0, 100, "Duration Sec");
    mSliders[16]->forceDecimalDigits(2);

    mSliders[17] = new ValueSlider(smallFont, x, boxY -= space, 2, 100, 20, 0, 100, "Pause Sec");
    mSliders[17]->forceDecimalDigits(2);

    mSliders[18] = new ValueSlider(smallFont, x, boxY -= space, 2, 100, 20, 0, 100, "Start Pause Sec");
    ...
    addKeyClassDescription(&mKeyLegend, "R-Click/arrows", "Move layer rot anchor");
...
static void adjustRecordList(SpriteAnimationRecord **inOldList, int inOldSize, int inNewSize)
{
    ...
    SpriteAnimationRecord *newRecords = new SpriteAnimationRecord[inNewSize];
    ...
    memcpy(newRecords, *inOldList, sizeof(SpriteAnimationRecord) * smallerSize);
...
static AnimationRecord *createRecordForObject(int inObjectID, AnimType inType)
{
    ...
    r->spriteAnim = new SpriteAnimationRecord[sprites];

    r->slotAnim = new SpriteAnimationRecord[slots];
...
void EditorAnimationPage::populateCurrentAnim()
{
    ...
    for (int i = 0; i < endAnimType; i++)
    {
        ...
        AnimationRecord *oldRecord = getAnimation(mCurrentObjectID, (AnimType)i);

        if (oldRecord == NULL)
        {
            // no anim exists
            mCurrentAnim[i] = createRecordForObject(mCurrentObjectID, (AnimType)i);
        }
        else
        {
            mCurrentAnim[i] = copyRecord(oldRecord);

            adjustRecordList(&(mCurrentAnim[i]->spriteAnim), mCurrentAnim[i]->numSprites, sprites);

            mCurrentAnim[i]->numSprites = sprites;

            adjustRecordList(&(mCurrentAnim[i]->slotAnim), mCurrentAnim[i]->numSlots, slots);
    ...
    for (int i = 0; i < numExtra; i++)
    {
        ...
        AnimationRecord *oldRecord = getAnimation(mCurrentObjectID, extra);

        mCurrentExtraAnim.push_back(copyRecord(oldRecord));

        mCurrentAnim[extra] = mCurrentExtraAnim.getElementDirect(mCurrentExtraAnim.size() - 1);

        adjustRecordList(&(mCurrentAnim[extra]->spriteAnim), mCurrentAnim[extra]->numSprites, sprites);

        mCurrentAnim[extra]->numSprites = sprites;

        adjustRecordList(&(mCurrentAnim[extra]->slotAnim), mCurrentAnim[extra]->numSlots, slots);
...
void EditorAnimationPage::updateAnimFromSliders()
{
    ...
    {
        r = &(anim->slotAnim[mCurrentSpriteOrSlot - anim->numSprites]);
    }
    else
    {
...
SpriteAnimationRecord *EditorAnimationPage::getRecordForCurrentSlot(char *outIsSprite)
{
...
void EditorAnimationPage::updateSlidersFromAnim()
{
    ...
    mReverseRotationCheckbox.setToggled(r->rotPerSec < 0 || r->rotPhase < 0);
...
static void copyChainToBody(ObjectRecord *inObject, double inAge, int inStartSpriteIndex, int inBodyIndex,
                            AnimationRecord *inAnim, SimpleVector<SpriteAnimationRecord> *inVector)
{
    inVector->deleteAll();
...
static void pasteChainToBody(ObjectRecord *inObject, double inAge, int inStartSpriteIndex, int inBodyIndex,
                             AnimationRecord *inAnim, SimpleVector<SpriteAnimationRecord> *inVector)
{
...
void EditorAnimationPage::soundIndexChanged(char inPageChange)
{
    if (mCurrentSound < mCurrentAnim[mCurrentType]->numSounds - 1 ||
        (mCurrentSound == mCurrentAnim[mCurrentType]->numSounds - 1 &&
         mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].sound.numSubSounds > 0))
    {
    ...
    if (mCurrentSound < mCurrentAnim[mCurrentType]->numSounds)
    {
        ...
        {
            mSoundWidget.setSoundUsage(mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].sound);
        }

        mSoundRepeatPerSecSlider.setValue(mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].repeatPerSec);

        mSoundRepeatPhaseSlider.setValue(mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].repeatPhase);
        ...
        mSoundFootstepButton.setToggled(mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].footstep);

        if (person)
        {

            double in = mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].ageStart;
            double out = mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].ageEnd;
    ...
    mPasteSoundAnimButton.setVisible(mSoundAnimCopyBuffer.sound.numSubSounds > 0 || mAllCopyBufferSounds.size() > 0);
...
void EditorAnimationPage::actionPerformed(GUIComponent *inTarget)
{
    ...
    else if (inTarget == &mDeleteButton)
    {
        for (int i = 0; i < endAnimType; i++)
        {
            clearAnimation(mCurrentAnim[i]->objectID, mCurrentAnim[i]->type);
        }
        mCurrentSound = 0;
    ...
    else if (inTarget == &mCopySoundAnimButton)
    {
        ...
        mSoundAnimCopyBuffer = copyRecord(mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound]);
    ...
    else if (inTarget == &mPasteSoundAnimButton)
    {
        if (mAllCopyBufferSounds.size() > 0)
        {
            ...
            if (mCurrentSound > 0)
            {
                ...
                for (int i = 0; i < mAllCopyBufferSounds.size(); i++)
                {
                    ...
                    mCurrentAnim[mCurrentType]->soundAnim =
                        new SoundAnimationRecord[mCurrentAnim[mCurrentType]->numSounds];

                    memcpy(mCurrentAnim[mCurrentType]->soundAnim, old,
                           sizeof(SoundAnimationRecord) * mCurrentAnim[mCurrentType]->numSounds - 1);

                    delete[] old;

                    mCurrentAnim[mCurrentType]->soundAnim[mCurrentAnim[mCurrentType]->numSounds - 1] =
            ...
            else
            {
                ...
                {
                    freeRecord(&(mCurrentAnim[mCurrentType]->soundAnim[i]));
                }
                delete[] mCurrentAnim[mCurrentType]->soundAnim;

                mCurrentAnim[mCurrentType]->numSounds = mAllCopyBufferSounds.size();

                mCurrentAnim[mCurrentType]->soundAnim = new SoundAnimationRecord[mAllCopyBufferSounds.size()];

                for (int i = 0; i < mAllCopyBufferSounds.size(); i++)
                {
                    mCurrentAnim[mCurrentType]->soundAnim[i] = copyRecord(mAllCopyBufferSounds.getElementDirect(i));
                }
            }
        }
        else
        {
            ...
            if (mCurrentSound < mCurrentAnim[mCurrentType]->numSounds)
            {
                ...
                freeRecord(&(mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound]));

                mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound] = copyRecord(mSoundAnimCopyBuffer);
            }
            else
            {
                // add new
                ...
                mCurrentAnim[mCurrentType]->soundAnim = new SoundAnimationRecord[mCurrentAnim[mCurrentType]->numSounds];
        ...
        if (!getObject(mCurrentObjectID)->person)
        {
            ...
            for (int i = 0; i < mCurrentAnim[mCurrentType]->numSounds; i++)
            {
                mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].ageStart = -1;
                mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].ageEnd = -1;
            }
        }
    ...
    else if (inTarget == &mFullSoundCopyButton)
    {
        ...
        for (int i = 0; i < endAnimType; i++)
        {
            ...
            {
                mFullSoundCopyBuffer[i].push_back(copyRecord(mCurrentAnim[i]->soundAnim[j]));
            }
        }
    ...
    else if (inTarget == &mFullSoundPasteButton)
    {
        ...
        for (int i = 0; i < endAnimType; i++)
        {
            ...
            {
                mCurrentAnim[i]->soundAnim[j] = copyRecord(mFullSoundCopyBuffer[i].getElementDirect(j));
            }
        }
        soundIndexChanged();
    }
    ...
    else if (inTarget == &mCopyChainButton || inTarget == &mCopyChainRandButton)
    {
        mWalkCopied = false;
        mUpCopied = false;
    ...
    else if (inTarget == &mCopyWalkButton)
    {
        ...
        if (r->person)
        {
            ...
            if (frontFootIndex != -1)
            {
                copyChainToBody(r, age, frontFootIndex, bodyIndex, anim, &mCopiedFrontFootAnimChain);
            }

            if (backFootIndex != -1)
            {
                copyChainToBody(r, age, backFootIndex, bodyIndex, anim, &mCopiedBackFootAnimChain);
            }
            ...
            if (frontHandIndex != -1)
            {
                copyChainToBody(r, age, frontHandIndex, bodyIndex, anim, &mCopiedFrontHandAnimChain);
            }

            if (backHandIndex != -1)
            {
                copyChainToBody(r, age, backHandIndex, bodyIndex, anim, &mCopiedBackHandAnimChain);
            }
    ...
    else if (inTarget == &mPasteButton)
    {
        ...
        if (mWalkCopied && r->person)
        {
            ...
            if (frontFootIndex != -1)
            {
                pasteChainToBody(r, age, frontFootIndex, bodyIndex, anim, &mCopiedFrontFootAnimChain);
            }

            if (backFootIndex != -1)
            {
                pasteChainToBody(r, age, backFootIndex, bodyIndex, anim, &mCopiedBackFootAnimChain);
            }
            ...
            if (frontHandIndex != -1)
            {
                pasteChainToBody(r, age, frontHandIndex, bodyIndex, anim, &mCopiedFrontHandAnimChain);
            }

            if (backHandIndex != -1)
            {
                pasteChainToBody(r, age, backHandIndex, bodyIndex, anim, &mCopiedBackHandAnimChain);
            }
        }
        else if (mUpCopied && mChainCopyBuffer.size() > 0)
        {
            ...
            for (int i = mCurrentSpriteOrSlot; i < anim->numSprites; i++)
            {
                anim->spriteAnim[i] = mChainCopyBuffer.getElementDirect(chainIndex);
        ...
        else if (mAllCopyBufferSounds.size() > 0 || mAllCopyBufferSprites.size() > 0 || mAllCopyBufferSlots.size() > 0)
        {
            // paste all
            ...
            anim->soundAnim = new SoundAnimationRecord[mAllCopyBufferSounds.size()];

            for (int i = 0; i < mAllCopyBufferSounds.size(); i++)
            {

                anim->soundAnim[i] = copyRecord(mAllCopyBufferSounds.getElementDirect(i));
            }
            ...
            for (int i = 0; i < anim->numSprites && i < mAllCopyBufferSprites.size(); i++)
            {

                if (i < obj->numSprites && i < mAllCopySpriteIDs.size() &&
                    obj->sprites[i] == mAllCopySpriteIDs.getElementDirect(i))
                {

                    anim->spriteAnim[i] = mAllCopyBufferSprites.getElementDirect(i);
            ...
            for (int i = 0; i < missedIndices.size(); i++)
            {
                ...
                for (int s = 0; s < obj->numSprites && s < anim->numSprites; s++)
                {

                    if (spriteID == obj->sprites[s] && !hitIndices[s])
                    {

                        // matching sprite in dest obj, and
                        // no animation already assigned

                        anim->spriteAnim[s] = mAllCopyBufferSprites.getElementDirect(missedI);
            ...
            for (int i = 0; i < anim->numSlots && i < mAllCopyBufferSlots.size(); i++)
            {

                anim->slotAnim[i] = mAllCopyBufferSlots.getElementDirect(i);
            }
    ...
    else if (inTarget == &mObjectPicker)
    {
        ...
        if (newPickID != -1)
        {
            ...
            else
            {
                ...
                if (oldID != -1 && oldID != mCurrentObjectID && isLastMouseButtonRight())
                {
                    ...
                    if (oldObj->numSprites == newObj->numSprites && oldObj->numSlots == newObj->numSlots)
                    {
                        keepOldID = true;
                    }
                }
                ...
                else if (isLastMouseButtonRight())
                {
                    ...
                    if (isSpriteSubset(oldID, mCurrentObjectID, &map))
                    {
                        ...
                        for (int i = 0; i < endAnimType; i++)
                        {
                            AnimationRecord *newR = getAnimation(newID, (AnimType)i);
                            if (newR == NULL)
                            {
                                continue;
                            }
                            ...
                            {
                                SubsetSpriteIndexMap s = map.getElementDirect(m);

                                mCurrentAnim[i]->spriteAnim[s.superIndex] = newR->spriteAnim[s.subIndex];
                            }
                        }
                    }
                }
                ...
                else
                {
                    ...
                    if (mCheckboxes[3]->getToggled() || mCheckboxes[4]->getToggled() || mCheckboxes[5]->getToggled() ||
    ...
    else if (inTarget == &mSoundWidget)
    {
        ...
        if (mCurrentSound < mCurrentAnim[mCurrentType]->numSounds)
        {
            if (u.numSubSounds > 0)
            { // just set it
                SoundUsage oldU = mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].sound;
                mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].sound = copyUsage(u);
                countLiveUse(u);
                unCountLiveUse(oldU);
            ...
            else if (!mSoundWidget.isRecording())
            {
                ...
                if (mCurrentAnim[mCurrentType]->numSounds > mCurrentSound + 1)
                {

                    memcpy(&(mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound]),
                           &(mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound + 1]),
                           sizeof(SoundAnimationRecord) * (mCurrentAnim[mCurrentType]->numSounds - mCurrentSound));
                }
                mCurrentAnim[mCurrentType]->numSounds--;
            ...
            else
            {
                ...
                // its replacement
                unCountLiveUse(mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].sound);

                clearSoundUsage(&(mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].sound));
        ...
        else if (u.numSubSounds > 0)
        {
            ...
            mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].sound = copyUsage(u);
            mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].repeatPerSec = 0;
            mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].repeatPhase = 0;
            mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].ageStart = -1;
            mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].ageEnd = -1;

            mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].footstep = false;
    ...
    else if (inTarget == &mSoundAgeInField)
    {
        ...
        mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].ageStart = value;
    }
    ...
    {
        mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].footstep = mSoundFootstepButton.getToggled();
    }
    ...
    {
        mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].repeatPerSec = mSoundRepeatPerSecSlider.getValue();
    }
    else if (inTarget == &mSoundRepeatPhaseSlider)
    {
        mCurrentAnim[mCurrentType]->soundAnim[mCurrentSound].repeatPhase = mSoundRepeatPhaseSlider.getValue();
    }
    ...
    {
        mCurrentAnim[mCurrentType]->randomStartPhase = mRandomStartPhaseCheckbox.getToggled();
    }
    else if (inTarget == &mForceZeroStartCheckbox)
    {
        mCurrentAnim[mCurrentType]->forceZeroStart = mForceZeroStartCheckbox.getToggled();
    }
    else if (inTarget == &mPrevExtraButton)
    {
        mCurrentAnim[extraB] = mCurrentExtraAnim.getElementDirect(mCurrentExtraIndex);
        ...
        mCurrentAnim[mCurrentType] = mCurrentExtraAnim.getElementDirect(mCurrentExtraIndex);
        soundIndexChanged();
    }
    else if (inTarget == &mNextExtraButton)
    {
        ...
        {
            // add a new one
            AnimationRecord *r = createRecordForObject(mCurrentObjectID, extra);
    ...
    {
        AnimationRecord *r = mCurrentExtraAnim.getElementDirect(mCurrentExtraIndex);
    ...
    else if (inTarget == &mTestSpeedSlider)
    {
        ...
        double oldFrameTime = (mFrameCount / 60.0) * factor;
    ...
    else if (inTarget == &mSpeedMultApplyButton)
    {
        ...
        if (mult > 0 && mult != 1.0f)
        {
            ...
            {
                SpriteAnimationRecord *r = &(mCurrentAnim[mCurrentType]->spriteAnim[i]);
            ...
            {
                SpriteAnimationRecord *r = &(mCurrentAnim[mCurrentType]->slotAnim[i]);
            ...
            for (int i = 0; i < mCurrentAnim[mCurrentType]->numSounds; i++)
            {
                SoundAnimationRecord *r = &(mCurrentAnim[mCurrentType]->soundAnim[i]);
    ...
    else
    {
        ...
        if (mCurrentObjectID != -1 && oldType != mCurrentType)
        {
            ...
            else if (mCurrentType == moving && oldType != moving && mFrozenRotFrameCountUsed)
            {
            ...
            if (!isAnimFadeNeeded(mCurrentObjectID, mCurrentAnim[mLastType], mCurrentAnim[mCurrentType]))
            {
        ...
        if (inTarget == mXOffsetSlider || inTarget == mYOffsetSlider)
        {
            updateAnimFromSliders();
        }
    }
...
double EditorAnimationPage::computeFrameTime()
{
    ...
    double frameTime = (mFrameCount / 60.0) * factor;

    if (animFade < 1)
    {
        factor = mCurrentObjectFrameRateFactor;

        frameTime = (mLastTypeFrameCount / 60.0) * factor;
    }
...
void EditorAnimationPage::drawUnderComponents(doublePair inViewCenter, double inViewSize)
{
    ...
    if (mCurrentObjectID != -1)
    {
        ...
        if (anim != NULL)
        {
            ...
            double frozenRotFrameTime = (mFrozenRotFrameCount / 60.0) * factor;

            double fadeTargetFrameTime = frameTime;

            if (mCurrentType == moving || mHeldID != -1)
            {
            ...
            if (demoSlots != NULL)
            {
                drawObjectAnim(mCurrentObjectID, anim, frameTime, animFade, fadeTargetAnim, fadeTargetFrameTime,
                               frozenRotFrameTime, &mFrozenRotFrameCountUsed, animRotFrozen, NULL, NULL, pos, 0, false,
                               mFlipDraw, age, false, false, false, mClothingSet, NULL, obj->numSlots, demoSlots, NULL);
            }
            else
            {
                ...
                if ((heldObject != NULL && heldObject->rideable) || hideClosestArm == -2)
                {
                ...
                if ((heldObject != NULL && heldObject->rideable))
                {
                    ...
                    personPos =
                        sub(personPos, getAgeBodyOffset(age, personObj->spritePos[getBodyIndex(personObj, age)]));
                }

                char splitHeld = false;

                if (heldObject != NULL && heldObject->rideable && heldObject->anySpritesBehindPlayer)
                {
                    splitHeld = true;
                }
                ...
                if (splitHeld)
                {
                    ...
                    prepareToSkipSprites(getObject(mCurrentObjectID), false, true);

                    clothingToDraw = getEmptyClothingSet();
                }

                HoldingPos holdingPos = drawObjectAnim(
                    mCurrentObjectID, 2, anim, frameTime, animFade, fadeTargetAnim, fadeTargetFrameTime,
                    frozenRotFrameTime, &mFrozenRotFrameCountUsed, animRotFrozen, frozenArmAnim, frozenArmAnim,
                    personPos, 0, false, mFlipDraw, age, hideClosestArm, hideAllLimbs, false, clothingToDraw, NULL);
                ...
                if (heldObject != NULL)
                {
                    ...
                    computeHeldDrawPos(holdingPos, pos, heldObject, mFlipDraw, &holdPos, &holdRot);
                    ...
                    if (splitHeld)
                    {
                        ...
                        drawObjectAnim(mHeldID, 2, heldAnimType, frameTime, animFade, heldFadeTargetType,
                                       fadeTargetFrameTime, frozenRotFrameTime, &mFrozenRotFrameCountUsed, moving,
                                       moving, holdPos, holdRot, false, mFlipDraw, heldAge, false, false, false,
                                       getEmptyClothingSet(), NULL);
                        restoreSkipDrawing(getObject(mHeldID));

                        // now draw player in between
                        drawObjectAnim(mCurrentObjectID, 2, anim, frameTime, animFade, fadeTargetAnim,
                                       fadeTargetFrameTime, frozenRotFrameTime, &mFrozenRotFrameCountUsed,
                                       animRotFrozen, frozenArmAnim, frozenArmAnim, personPos, 0, false, mFlipDraw, age,
                                       hideClosestArm, hideAllLimbs, false, mClothingSet, NULL);
                    ...
                    drawObjectAnim(mHeldID, 2, heldAnimType, frameTime, animFade, heldFadeTargetType,
                                   fadeTargetFrameTime, frozenRotFrameTime, &mFrozenRotFrameCountUsed, moving, moving,
                                   holdPos, holdRot, false, mFlipDraw, heldAge, false, false, false,
                                   getEmptyClothingSet(), NULL);
        ...
        else
        {
            if (demoSlots != NULL)
            {
                drawObject(obj, pos, 0, false, mFlipDraw, age, false, false, false, mClothingSet, obj->numSlots,
                           demoSlots, NULL);
            }
            else
            {
                drawObject(obj, 2, pos, 0, false, mFlipDraw, age, false, false, false, mClothingSet);
            }
        }
        ...
        if (mSceneryID != -1)
        {
            ...
            for (int g = 0; g < groundPosList.size(); g++)
            {
                ...
                drawObject(getObject(mSceneryID), 2, groundPosList.getElementDirect(g), 0, false, false, 20, 0, false,
                           false, getEmptyClothingSet());
            }
        }
        ...
        if (mWiggleFade > 0 || mSettingRotCenter || mRotCenterFade > 0)
        {
            ...
            if (mCurrentSpriteOrSlot < r->numSprites)
            {
                ...
                doublePair center = add(r->spritePos[mCurrentSpriteOrSlot], pos);
                center = add(center, mCurrentAnim[mCurrentType]->spriteAnim[mCurrentSpriteOrSlot].rotationCenterOffset);
    ...
    if (!mHideUI && mCurrentObjectID != -1)
    {
        ...
        else
        {
            ...
            if (mCurrentSpriteOrSlot < getObject(mCurrentObjectID)->numSprites)
            {

                spriteID = getObject(mCurrentObjectID)->sprites[mCurrentSpriteOrSlot];
            }
        }
        ...
        pos.y += 28;
        smallFont->drawString(getObject(mCurrentObjectID)->description, pos, alignLeft);

        pos.y -= 56;

        if (spriteID != -1)
        {
            smallFont->drawString(getSpriteRecord(spriteID)->tag, pos, alignLeft);
        }
...
void EditorAnimationPage::step()
{
    ...
    if (mCurrentObjectID != -1)
    {
        ...
        for (int s = 0; s < mCurrentAnim[mCurrentType]->numSounds; s++)
        {
            ...
            SoundAnimationRecord soundAnim = mCurrentAnim[mCurrentType]->soundAnim[s];
            ...
            if (getObject(mCurrentObjectID)->person)
            {
                ...
                if ((soundAnim.ageStart != -1 && age < soundAnim.ageStart) ||
                    (soundAnim.ageEnd != -1 && age >= soundAnim.ageEnd))
                {
                    continue;
                }
            }
            ...
            if (hz != 0)
            {
                ...
                int oldPeriods = lrint(floor((oldFrameTime - startOffsetSec) / period));

                int newPeriods = lrint(floor((newFrameTime - startOffsetSec) / period));
...
int EditorAnimationPage::getClosestSpriteOrSlot(float inX, float inY)
{
    ...
    if (inX > -228 && inX < 228 && inY > -128 && inY < 160)
    {
        ...
        getClosestObjectPart(obj, NULL, NULL, NULL, false, age, -1, mFlipDraw, mousePos.x, mousePos.y, &pickedSprite,
                             &pickedClothing, &pickedSlot, true, true);
...
void EditorAnimationPage::pointerMove(float inX, float inY)
{
    ...
    else if (inX < 228 && inX > -228 && inY < 160 && inY > -128)
    {
...
void EditorAnimationPage::pointerDrag(float inX, float inY)
{
    ...
    if (mCurrentObjectID != -1 && mSettingRotCenter)
    {
        ...
        if (mCurrentSpriteOrSlot < r->numSprites)
        {
            ...
            mCurrentAnim[mCurrentType]->spriteAnim[mCurrentSpriteOrSlot].rotationCenterOffset = delta;
        }
    }
}
...
void EditorAnimationPage::specialKeyDown(int inKeyCode)
{
    ...
    if (mCurrentObjectID != -1)
    {
        ...
        if (mCurrentSpriteOrSlot < obj->numSprites)
        {
            ...
            {
            case MG_KEY_LEFT:
                mCurrentAnim[mCurrentType]->spriteAnim[mCurrentSpriteOrSlot].rotationCenterOffset.x -= offset;
                mRotCenterFade = 1.0;
                break;
            case MG_KEY_RIGHT:
                mCurrentAnim[mCurrentType]->spriteAnim[mCurrentSpriteOrSlot].rotationCenterOffset.x += offset;
                ...
                break;
            case MG_KEY_DOWN:
                mCurrentAnim[mCurrentType]->spriteAnim[mCurrentSpriteOrSlot].rotationCenterOffset.y -= offset;
                mRotCenterFade = 1.0;
                break;
            case MG_KEY_UP:
                mCurrentAnim[mCurrentType]->spriteAnim[mCurrentSpriteOrSlot].rotationCenterOffset.y += offset;
