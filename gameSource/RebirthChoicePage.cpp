...
RebirthChoicePage::RebirthChoicePage()
    : mBackground("background.tga", 0.75f),
      ...
      mQuitButton(mainFont, 0, -224, translate("quit")),
      mReviewButton(mainFont, 150, 64, translate("postReviewButton")),
      mRebornButton(mainFont, 0, 64, translate("reborn")),
      mGenesButton(mainFont, 0, -32, translate("geneticHistoryButton")),
      mSettingsButton(mainFont, 0, -32, translate("settingsButton")),
      mTutorialButton(mainFont, 0, 64, translate("tutorial")), mMenuButton(mainFont, 0, -128, "BACK")
{
...
void RebirthChoicePage::draw(doublePair inViewCenter, double inViewSize)
{
