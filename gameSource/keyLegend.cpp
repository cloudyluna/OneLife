...
void addKeyDescription(KeyLegend *inLegend, char inKey, const char *inDescription)
{
...
void addKeyClassDescription(KeyLegend *inLegend, const char *inKeyClassName, const char *inDescription)
{
...
void drawKeyLegend(KeyLegend *inLegend, doublePair inPos, TextAlignment inAlign)
{
    ...
    for (int i = 0; i < numKeys; i++)
    {
        ...
        const char *keyClassName = inLegend->keyClassNames.getElementDirect(i);
