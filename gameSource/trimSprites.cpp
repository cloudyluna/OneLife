                ...
                if (infoFile != NULL)
                {
                    ...
                    if (numTokens <= 2)
                    {
                        ...
                        if (lastX > firstX && lastY > firstY)
                        {
                            ...
                            trimmedImage = image->getSubImage(firstX, firstY, 1 + lastX - firstX, 1 + lastY - firstY);
                        }
                        else
                        {
                        ...
                        Image *trimmedExpandedImage = expandToPowersOfTwo(trimmedImage);
                        ...
                        FileOutputStream *outStream = new FileOutputStream(files[i]);
                        ...
                        char *newContents = autoSprintf("%s %d %d", contents, centerOffsetX, centerOffsetY);
