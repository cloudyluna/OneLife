...
KeyEquivalentTextButton::KeyEquivalentTextButton(Font *inDisplayFont, double inX, double inY, const char *inLabelText,
                                                 unsigned char inKeyA, unsigned char inKeyB)
    : TextButton(inDisplayFont, inX, inY, inLabelText), mKeyA(inKeyA), mKeyB(inKeyB)
{
}
...
void KeyEquivalentTextButton::keyDown(unsigned char inASCII)
{
    ...
    if (((mKeyA == 'z') && inASCII == 26) || ((mKeyA == 'x') && inASCII == 24) || ((mKeyA == 'w') && inASCII == 23) ||
        ((mKeyA == 'v') && inASCII == 22) || ((mKeyA == 'e') && inASCII == 5) || ((mKeyA == 'a') && inASCII == 1) ||
