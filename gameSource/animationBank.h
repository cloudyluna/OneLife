...
AnimationRecord *copyRecord(AnimationRecord *inRecord, char inCountLiveSoundUses = true);

// should only be called on results of copyRecord and NOT
// on results of getAnimation
void freeRecord(AnimationRecord *inRecord);

SoundAnimationRecord copyRecord(SoundAnimationRecord inRecord, char inCountLiveSoundUses = true);
...
HoldingPos drawObjectAnim(int inObjectID, int inDrawBehindSlots, AnimType inType, double inFrameTime, double inAnimFade,
                          ...
                          double *outSlotRots = NULL, doublePair *outSlotOffsets = NULL);
...
HoldingPos drawObjectAnim(int inObjectID, int inDrawBehindSlots, AnimationRecord *inAnim, double inFrameTime,
                          ...
                          AnimationRecord *inFrozenArmAnim, AnimationRecord *inFrozenArmFadeTargetAnim,
...
void drawObjectAnim(int inObjectID, AnimationRecord *inAnim, double inFrameTime, double inAnimFade,
                    ...
                    // set NULL for no frozen arms
                    AnimationRecord *inFrozenArmAnim, AnimationRecord *inFrozenArmFadeTargetAnim, doublePair inPos,
                    double inRot, char inWorn, char inFlipH, double inAge, int inHideClosestArm, char inHideAllLimbs,
                    char inHeldNotInPlaceYet, ClothingSet inClothing, SimpleVector<int> *inClothingContained,
                    int inNumContained, int *inContainedIDs, SimpleVector<int> *inSubContained);
